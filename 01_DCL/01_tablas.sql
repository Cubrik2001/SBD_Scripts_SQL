...
CREATE TABLE CATALOGO_PAIS (
    ...
    CONSTRAINT FK_CATALOGO_PROD FOREIGN KEY (id_producto_juguete_lego) REFERENCES JUGUETES_LEGO (id)
);
...
CREATE TABLE HIST_PRECIOS (
    ...
    CONSTRAINT FK_HIST_PROD FOREIGN KEY (id_producto) REFERENCES JUGUETES_LEGO (id)
);
...
CREATE TABLE PRODUCTOS_RELACION (
    ...
    CONSTRAINT FK_REL_PROD_A FOREIGN KEY (id_producto_a) REFERENCES JUGUETES_LEGO (id),
    CONSTRAINT FK_REL_PROD_B FOREIGN KEY (id_producto_b) REFERENCES JUGUETES_LEGO (id)
);
...
CREATE TABLE TEMAS_PRODUCTOS (
    ...
    CONSTRAINT FK_TP_PROD FOREIGN KEY (id_producto) REFERENCES JUGUETES_LEGO (id)
);
...
CREATE TABLE LOTES_INVENTARIO (
    ...
    CONSTRAINT FK_LOTES_PROD FOREIGN KEY (id_producto) REFERENCES JUGUETES_LEGO (id)
);
