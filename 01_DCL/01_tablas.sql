...
CREATE TABLE INSCRITOS (
    ...
    CONSTRAINT PK_INSCRITOS PRIMARY KEY (id,fecha_tour_inscrito,nro_inscripcion),
...
CREATE TABLE ENTRADAS (
    nro_inscripcion_tour NUMBER NOT NULL,
    id              NUMBER NOT NULL,
    tipo_cliente    CHAR(1) NOT NULL,
    CONSTRAINT CK_TIPO_CLIENTE_ENTRADA CHECK (tipo_cliente IN ('A', 'N'))

--// ‘A’ significa ADULTO, ‘N’ significa NINO

    CONSTRAINT PK_ENTRADAS PRIMARY KEY (nro_inscripcion_tour, id),
...
CREATE TABLE LOTES_INVENTARIO (
    ...
    id_juguete     NUMBER NOT NULL,
    cantidad        NUMBER NOT NULL,
    CONSTRAINT PK_LOTES PRIMARY KEY (id_lote,id_tienda,id_juguete),
...
CREATE TABLE DESCUENTO_L_INVENTARIO (
    ...
    CONSTRAINT PK_DESC_INVENTARIO PRIMARY KEY (id_lote, id_tienda ,id_juguete ,id),
